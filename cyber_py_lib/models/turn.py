...
class Turn(object):
    ...
    @property
    def status(self):
        """Gets the status of this Turn.  # noqa: E501


        :return: The status of this Turn.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this Turn.


        :param status: The status of this Turn.  # noqa: E501
        :type: str
        """
        if status is None:
            raise ValueError("Invalid value for `status`, must not be `None`")  # noqa: E501
        allowed_values = ["in-progress", "turn-complete"]  # noqa: E501
